...
#    مرزِ غیررقم لازم است: شمارهٔ واقعی وسطِ یک رشتهٔ بلندترِ رقم نمی‌نشیند.
#    بدونش، کدِ نمادِ بورس (۳۲۰۹۷۸۲۸۷۹۹۱۳۸۹۵۷) به‌عنوان تلفن گزارش می‌شد.
#    {9,10} هم برای این است که +98 ده رقم بعدش دارد و 09 نه رقم.
hits=$(git grep --cached -noE '(^|[^0-9])(\+98|0098|09)[0-9]{9,10}([^0-9]|$)' 2>/dev/null | head -3)

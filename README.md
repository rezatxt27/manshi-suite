...
| **کارها** | فهرست و کانبان، پروندهٔ پروژه، اولویت، تکرارشونده، زیرکار، توضیحاتِ زمان‌دار، تخمین زمان، پیگیریِ سپرده‌شده‌ها، مرور کارهای پوسیده |
| **آدم‌ها** | پروندهٔ افراد از روی جلسه‌ها و کارها |
| **گزارش** | آمار هفتگی و گزارش متنی |
| **کیوسک** | تقویم و مناسبت‌ها، اوقات شرعی، سخن روز، بازار، بورس، اخبار، تایمر تمرکز |
...
core/
  ...
  bourse.js                    دیدهٔ بازارِ بورس: بیشترین رشد، افت و پرمعامله
...
tests/run.js                   ۵۴۸ تست، بدون هیچ وابستگی
```
